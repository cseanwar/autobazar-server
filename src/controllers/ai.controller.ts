...
const DESCRIPTION_TEMPLATES: Record<string, string> = {
  professional:
    "Write a professional, detailed car listing description. Focus on specifications, condition, and value proposition. Be factual and precise.",
  enthusiast:
    "Write an engaging, passionate car listing description. Highlight performance, driving experience, and unique characteristics. Use energetic language.",
  luxury:
    "Write an elegant, refined car listing description. Emphasize craftsmanship, premium features, and exclusivity. Use sophisticated language.",
};
